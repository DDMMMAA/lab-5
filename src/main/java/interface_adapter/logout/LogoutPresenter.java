...
public class LogoutPresenter implements LogoutOutputBoundary {
    ...
    public LogoutPresenter(ViewManagerModel viewManagerModel,
        ...
        // TD: assign to the three instance variables.
    ...
    public void prepareSuccessView(LogoutOutputData response) {
        ...
        // TD: have prepareSuccessView update the LoggedInState
        // 1. get the LoggedInState out of the appropriate View Model,
        // 2. set the username in the state to the empty string
        // 3. set the state in the LoggedInViewModel to the updated state
        // 4. firePropertyChanged so that the View that is listening is updated.33.
        final LoggedInState loggedInState = loggedInViewModel.getState();
        loggedInState.setUsername(response.getUsername());

        // TD: have prepareSuccessView update the LoginState
